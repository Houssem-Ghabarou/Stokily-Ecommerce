...
export default async function LocaleLandingPage({ locale }: { locale: Locale }) {
  ...
  return (
    <main className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-40 bg-blue-50/75 backdrop-blur-md border-b border-blue-100/50 shadow-sm">
      ...
      {/* Hero Section — standard SaaS-style: text + CTAs left, image right */}
      <section id="hero" className="relative overflow-hidden pt-24 pb-16 md:pt-28 md:pb-20 lg:pt-32 lg:pb-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center min-h-0">
            {/* Left: headline, subtitle, description, CTAs */}
            <div className="order-2 lg:order-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-8">
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-gray-900 text-white px-6 py-3.5 rounded-xl hover:bg-gray-800 transition-all duration-200 shadow-md hover:shadow-lg w-full sm:w-auto justify-center font-medium"
                >
                  <svg className="w-6 h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
                    <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
                  </svg>
                  <span className="text-sm sm:text-base">{dict.hero.downloadAppStore}</span>
                </a>
                <a
                  href={PLAY_STORE_URL}
                  target="_blank"
                ...
                >
                  ...
                  <span className="text-sm sm:text-base">{dict.hero.downloadPlayStore}</span>
                </a>
              </div>
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 text-sm text-gray-600">
                <span className="flex items-center gap-2">
                  ...
                  {dict.hero.worksOffline}
                </span>
                <span className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-emerald-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {dict.hero.barcodeScanning}
                </span>
                <span className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-emerald-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {dict.hero.multiLanguage}
                </span>
              </div>
            </div>
            {/* Right: hero image — contained, not stretched */}
            <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-lg mx-auto lg:max-w-none">
                <Image
                  src="/stokily/hero-sectionimage.jpg"
                  alt="Stokily app — inventory, POS, and business management on mobile"
                  width={720}
                  height={540}
          ...
          <div className="mt-10 lg:mt-12 flex justify-center">
            ...
            >
              <span className="text-xs font-medium">{dict.hero.scrollHint}</span>
